...
const auditLogs = [
  { id: 1, type: 'Monthly Data', generatedBy: 'Admin-08', date: '09-10-2025', status: 'Completed', action: 'Download' },
  { id: 2, type: 'Monthly Data', generatedBy: 'Admin-08', date: '09-10-2025', status: 'Completed', action: 'Download' },
  { id: 3, type: 'Monthly Data', generatedBy: 'Admin-08', date: '09-10-2025', status: 'Completed', action: 'Download' },
  { id: 4, type: 'Monthly Data', generatedBy: 'Admin-08', date: '09-10-2025', status: 'Completed', action: 'Download' }
];
  ...
  return (
    <div className="min-h-screen p-3">
      <div className="mx-auto">
        {/* Header */}
        <h1 className="text-2xl font-bold text-gray-900 mb-4 mt-4">Visual KPI Overview</h1>
        ...
        {/* Visual Analytics */}
        <h2 className="text-xl font-bold text-gray-900 mb-6">Visual Analytics</h2>
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            ...
            <ResponsiveContainer width="100%" height={250}>
              <LineChart data={meetingTrendsData}>
                ...
                <YAxis tick={{ fontSize: 12 }} />
                <Tooltip />
                <Line type="monotone" dataKey="series1" stroke="#3B82F6" strokeWidth={2} dot={{ r: 3 }} />
                <Line type="monotone" dataKey="series2" stroke="#10B981" strokeWidth={2} dot={{ r: 3 }} />
                <Line type="monotone" dataKey="series3" stroke="#8B5CF6" strokeWidth={2} dot={{ r: 3 }} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Upcoming Meetings & Events</h3>
            <div className="mb-4">
              <div className="grid grid-cols-7 gap-2 mb-2">
                {['S', 'M', 'T', 'W', 'T', 'F', 'S'].map((day, i) => (
                  <div key={i} className="text-center text-xs font-semibold text-blue-600 bg-blue-50 py-1 rounded">
                    {day}
                  </div>
                ))}
              </div>
                ...
                {Array.from({ length: 35 }, (_, i) => (
                  <div
                    ...
                    className={`aspect-square rounded flex items-center justify-center text-xs ${
                      i === 20 ? 'bg-blue-500 text-white font-semibold' : 'bg-gray-100 text-gray-400'
                    }`}
                  >
                    {i < 5 ? '' : i - 4}
                  </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">System Reports / Audit Logs</h3>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Sr. No</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Report Type</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Generated By</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Date</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Status</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Action</th>
                  <th className="text-left py-3 px-4 text-sm font-semibold text-gray-600">Download</th>
                </tr>
              </thead>
              <tbody>
                {auditLogs.map((log) => (
                  <tr key={log.id} className="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="py-3 px-4 text-sm text-gray-900">{log.generatedBy}</td>
