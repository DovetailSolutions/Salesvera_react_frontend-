      ...
      <div className="flex items-center gap-3 min-w-0">
        ...
        <div className="min-w-0">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400 mt-0.5 truncate flex items-center gap-3">
            ...
            {sub.hsn && (
              <span className="flex items-center gap-1">
                <Hash className="w-3 h-3" /> {sub.hsn}
              </span>
            )}
            {sub.unit && (
...
export default function Category() {
  ...
  const cancelSubEdit = () => {
    ...
    setSubFormData({ sub_category_name: "", amount: "", tax: "", unit: "", hsn: "" });
    setSubFormErrors({});
  };
  ...
  const handleSubmitSubCategory = async () => {
    ...
    try {
      ...
      if (editingSubId) {
        ...
        updateData.append("hsn", subFormData.hsn.trim());
  ...
  const isSubFormDirty = subFormData.sub_category_name || subFormData.amount || subFormData.tax !== "" || subFormData.unit || subFormData.hsn;
    ...
    <div className="py-4 h-[calc(100vh-6rem)] flex flex-col relative">
      ...
      {isSubModalOpen && selectedCategory && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-900/40 backdrop-blur-sm p-0 sm:p-4 animate-in fade-in duration-200">
          <div className="popup-card custom-border rounded-t-3xl sm:rounded-3xl shadow-2xl w-full max-w-4xl flex flex-col max-h-[92vh] animate-in slide-in-from-bottom-4 sm:zoom-in-95 duration-250">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={(e) => handleSubFieldChange("unit", e.target.value)}
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={subFormData.hsn}
                        onChange={(e) => handleSubFieldChange("hsn", e.target.value)}
                        onKeyDown={(e) => { if (e.key === "Enter") handleSubmitSubCategory(); }}
